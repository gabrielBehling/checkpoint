...
function App() {
    ...
    const fetchCarouselData = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                const newCarouselData = response.data.data.data.map(
                    (event) => ({
                        id: event.eventId,
                        src:
                ...
                {!user && (
                    <div className="cta">
                        <p>
                            ...
                            <br />
                            Tenha acesso a conteúdos especiais, ofertas e
